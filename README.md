...
## 📝 **نحوه استفاده از لینک‌های داخلی:**

1. **برای لینک‌دهی**: از `#آیدی-بخش` استفاده کنید
2. **برای تعریف آیدی**: `{#آیدی-بخش}` در کنار تیترها
3. **کلیک روی هر لینک در فهرست**، شما را به بخش مربوطه می‌برد
4. **دکمه‌های [⬆ بازگشت به فهرست]** شما را به ابتدای صفحه بازمی‌گردانند

**مثال**:  
`[📦 مدیریت پکیج](#مدیریت-پکیج)` ← این لینک شما را به بخش مدیریت پکیج می‌برد
